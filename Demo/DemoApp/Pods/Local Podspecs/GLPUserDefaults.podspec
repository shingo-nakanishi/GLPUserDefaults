#
#  Be sure to run `pod spec lint GLPUserDefaults.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "shingo.nakanishi" => "shingo.nakanishi@glpgs.com", "other author" => "email@address.com" }
  # s.author       = 'shingo.nakanishi', 'other author'
  ...
  s.source       = { :git => "http://EXAMPLE/GLPUserDefaults.git", :tag => "0.0.1" }
